...
namespace CustomerSurvey3.Web
{
    ...
    public sealed partial class SurveyInstance : Entity
    {
        ...
        /// <summary>
        /// Gets the collection of associated <see cref="SurveyAnswer"/> entities.
        /// </summary>
    ...
    public sealed partial class SurveyType : Entity
    {
        ...
        /// <summary>
        /// Gets the collection of associated <see cref="SurveyInstance"/> entities.
        /// </summary>
        ...
        /// <summary>
        /// Gets the collection of associated <see cref="SurveyQuestion"/> entities.
        /// </summary>
...
namespace CustomerSurvey3.Web.Services
{
    ...
    /// <summary>
    /// The domain context corresponding to the 'SurveyService' domain service.
    /// </summary>
    public sealed partial class SurveyContext : DomainContext
    {
        ...
        /// <summary>
        /// Gets the set of <see cref="Lookup"/> entities that have been loaded into this <see cref="SurveyContext"/> instance.
        /// </summary>
        ...
        /// <summary>
        /// Gets the set of <see cref="SurveyAnswer"/> entities that have been loaded into this <see cref="SurveyContext"/> instance.
        /// </summary>
        ...
        /// <summary>
        /// Gets the set of <see cref="SurveyInstance"/> entities that have been loaded into this <see cref="SurveyContext"/> instance.
        /// </summary>
        ...
        /// <summary>
        /// Gets the set of <see cref="SurveyQuestion"/> entities that have been loaded into this <see cref="SurveyContext"/> instance.
        /// </summary>
        ...
        /// <summary>
        /// Gets the set of <see cref="SurveyType"/> entities that have been loaded into this <see cref="SurveyContext"/> instance.
        /// </summary>
        ...
        /// <summary>
        /// Gets the set of <see cref="SurveyUser"/> entities that have been loaded into this <see cref="SurveyContext"/> instance.
        /// </summary>
        ...
        /// <summary>
        /// Gets the set of <see cref="FindUHTenant_Result"/> entities that have been loaded into this <see cref="SurveyContext"/> instance.
        /// </summary>
        ...
        /// <summary>
        /// Gets an EntityQuery instance that can be used to load <see cref="Lookup"/> entities using the 'GetLookups' query.
        /// </summary>
        /// <returns>An EntityQuery that can be loaded to retrieve <see cref="Lookup"/> entities.</returns>
        ...
        /// <summary>
        /// Gets an EntityQuery instance that can be used to load <see cref="SurveyAnswer"/> entities using the 'GetSurveyAnswers' query.
        /// </summary>
        /// <returns>An EntityQuery that can be loaded to retrieve <see cref="SurveyAnswer"/> entities.</returns>
        ...
        /// <summary>
        /// Gets an EntityQuery instance that can be used to load <see cref="SurveyInstance"/> entities using the 'GetSurveyInstances' query.
        /// </summary>
        /// <returns>An EntityQuery that can be loaded to retrieve <see cref="SurveyInstance"/> entities.</returns>
        ...
        /// <summary>
        /// Gets an EntityQuery instance that can be used to load <see cref="SurveyQuestion"/> entities using the 'GetSurveyQuestions' query.
        /// </summary>
        /// <returns>An EntityQuery that can be loaded to retrieve <see cref="SurveyQuestion"/> entities.</returns>
        ...
        /// <summary>
        /// Gets an EntityQuery instance that can be used to load <see cref="SurveyType"/> entities using the 'GetSurveyTypes' query.
        /// </summary>
        /// <returns>An EntityQuery that can be loaded to retrieve <see cref="SurveyType"/> entities.</returns>
        ...
        /// <summary>
        /// Gets an EntityQuery instance that can be used to load <see cref="SurveyUser"/> entities using the 'GetSurveyUsers' query.
        /// </summary>
        /// <returns>An EntityQuery that can be loaded to retrieve <see cref="SurveyUser"/> entities.</returns>
        ...
        /// <summary>
        /// Gets an EntityQuery instance that can be used to load <see cref="FindUHTenant_Result"/> entities using the 'GetTenants' query.
        /// </summary>
        ...
        /// <returns>An EntityQuery that can be loaded to retrieve <see cref="FindUHTenant_Result"/> entities.</returns>
        ...
        /// <summary>
        /// Asynchronously invokes the 'GetUserName' method of the domain service.
        /// </summary>
        ...
        /// <summary>
        /// Service contract for the 'SurveyService' domain service.
        /// </summary>
        [ServiceContract()]
